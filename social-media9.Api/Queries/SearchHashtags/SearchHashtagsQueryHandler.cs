// File: Api/Queries/SearchHashtags/SearchHashtagsQueryHandler.cs
...
namespace social_media9.Api.Queries.SearchHashtags
{
    public class SearchHashtagsQueryHandler : IRequestHandler<SearchHashtagsQuery, IEnumerable<PostSearchResultDto>>
    {
        ...
        public SearchHashtagsQueryHandler(IPostRepository postRepository)
        {
        ...
        {
            var results = await _postRepository.SearchHashtagsAsync(request.Query, request.Limit);
